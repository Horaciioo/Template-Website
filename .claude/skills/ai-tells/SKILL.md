...
État relevé le 2026-09-24. Sur un site vitrine, le texte de `messages/*.json` compte autant que le CSS : relire chaque nouvelle clé avec les signes 5 et 6.
...
| 6. Buzzwords            | Aucun. « Sur mesure » reste comme nom d'une offre réelle.                                                                                                                                                                                                               | `messages/*.json`                                    |
